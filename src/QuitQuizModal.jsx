...
export default function QuitQuizModal({ open, children, onClose }) {
            ...
            <div style={MODAL_STYLES}>
                <div className='relative flex-col w-full'>
                    <div className='flex items-center w-full h-[33%] bg-[#5F81AD] rounded-t-[36px]'>
                        <ExitToAppIcon fontSize="large" style={{ marginLeft: '25px', color: 'white', marginTop: '20px', marginBottom: '20px',  }} />
                    ...
                    <div className='flex items-center justify-center w-full h-[33%] bg-white'>
                        <h5 className='text-black text-lg font-medium mx-20 my-6'>Your progress will not be saved. Are you sure you want to exit the quiz?</h5>
                    </div>
                    <div className='flex justify-end w-full h-[33%] items-center bg-white rounded-b-[36px] pr-4 mb-4'>
                        <button onClick={onClose} className='mr-4 p-2 px-5 bg-white border border-[#525252] rounded-[30px] text-[#525252] hover:bg-[#525252] hover:text-white'>Cancel</button>
                        <Link to="/learning"><button onClick={onClose} className='mr-4 p-2 px-5 bg-[#5F81AD] border border-[#5F81AD] rounded-[30px] text-white hover:bg-white hover:text-[#5F81AD] '>OK</button></Link>
                    </div>
                </div>
                {children}
