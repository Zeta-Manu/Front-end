...
import QuitQuizModal from '@src/components/quiz/QuitQuizModal';
import FinalResultsModal from '@src/components/quiz/FinalResultsModal';
...
const Quiz = () => {
  ...
  const openFinalResults = (score: number) => {
    ...
    <div className="flex w-screen h-screen">
            ...
            <AppBar sx={{ background: '#C5DFE7', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)' }}>
              <Toolbar>
                ...
                <div style={{ flex: '1', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  <div className="text-xl text-black font-nunito-sans">
      ...
      <div className="flex-col w-screen h-screen">
        <div className="flex h-1/6 w-full mt-24 mx-5 pt-2 justify-center mx-20">
          <div
            className="w-9/12 h-5/6 bg-[#E3F6FC] rounded-2xl flex items-center"
            style={{ boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)' }}
          >
            <h1 className="text-xl font-bold text-black font-nunito-sans ml-10">
              Question{currentQuestion + 1}: What’s the meaning of this sign?{' '}
            </h1>
          </div>
        </div>
        ...
        <div className="flex h-2/6 w-full justify-center mt-10">
          <button
            onClick={checkanswer}
            className="w-1/6 h-1/4 text-xl text-white font-semibold bg-[#EB9980] rounded-lg hover:text-white hover:bg-[#FFC6B4]"
          >
            Submit
          </button>
        </div>
